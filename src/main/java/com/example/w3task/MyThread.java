...
public class MyThread {
    ...
    protected static final int ARR_SIZE = 50;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < NUM_THREADS; i++) {
            ...
            int endIndex = (i == NUM_THREADS - 1) ? ARR_SIZE - 1 : (startIndex + segmentSize - 1);
            threads[i] = new Thread(new ParallelSort.SortTask(array, startIndex, endIndex));
            threads[i].start();
        }
